  ...
  return (
    <Card 
      className={cn(
        ...
        isUserFee && "ring-2 ring-olimpics-orange-primary bg-orange-50"
      )}
    >
      <CardContent className="p-4 space-y-4">
        <div className="flex justify-between items-start">
          <div className="space-y-2">
            ...
            {isUserFee && (
              <div className="inline-block px-2 py-1 bg-olimpics-orange-primary text-white rounded-md text-sm">
        ...
        <div className="space-y-4 pt-4 border-t">
          ...
          {fee.contato_telefone && (
            <div 
              className="flex items-center gap-2 text-sm cursor-pointer hover:text-olimpics-orange-primary transition-colors"
          ...
          {fee.link_formulario && (
            <div className="flex items-center gap-2">
              <Button 
                ...
                className="w-full text-olimpics-background bg-orange-600 hover:bg-orange-500"
              >

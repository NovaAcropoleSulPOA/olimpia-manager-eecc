  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-olimpics-background to-white">
      <div 
        ...
        style={{
          backgroundImage: 'url("/lovable-uploads/EECC_marca_portugues_cores_RGB.png")',
      ...
      >
        <div className="absolute inset-0 bg-black/60" /> {/* Increased opacity for better readability */}
        <div className="container relative z-10 mx-auto px-4 py-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* Left side - Event Info */}
            <div className="text-white backdrop-blur-sm bg-black/20 p-6 rounded-lg">
              {/* Header Section */}
